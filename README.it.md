...
|---|---|---|
| `version` | `0.10.2` | Versione di Zenzic da installare. Pin a una release specifica per esecuzioni deterministiche. Imposta `latest` per valutazione continua. |
...
consulta l'[Engineering Ledger](https://zenzic.dev/it/developers/explanation/adr-vault).
